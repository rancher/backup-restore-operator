...
func (h *handler) downloadFromS3(restore *v1.Restore) error {
	...
	targetFileName, err := util.DownloadFromS3WithPrefix(s3Client, prefix, objStore.BucketName)
	if err != nil {
		return err
	}
	fmt.Printf("targetFileName: %v\n", targetFileName)
