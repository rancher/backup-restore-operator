...
import (
	...
	someapigroupv1 "github.com/mrajashree/backup/pkg/apis/some.api.group/v1"
...
func (c *FakeFoos) Get(ctx context.Context, name string, options v1.GetOptions) (result *someapigroupv1.Foo, err error) {
	obj, err := c.Fake.
...
func (c *FakeFoos) List(ctx context.Context, opts v1.ListOptions) (result *someapigroupv1.FooList, err error) {
	obj, err := c.Fake.
...
func (c *FakeFoos) Create(ctx context.Context, foo *someapigroupv1.Foo, opts v1.CreateOptions) (result *someapigroupv1.Foo, err error) {
	obj, err := c.Fake.
...
func (c *FakeFoos) Update(ctx context.Context, foo *someapigroupv1.Foo, opts v1.UpdateOptions) (result *someapigroupv1.Foo, err error) {
	obj, err := c.Fake.
...
func (c *FakeFoos) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *someapigroupv1.Foo, err error) {
	obj, err := c.Fake.
