...
import (
	...
	versioned "github.com/mrajashree/backup/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/mrajashree/backup/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/mrajashree/backup/pkg/generated/listers/some.api.group/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SomeV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SomeV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&someapigroupv1.Foo{},
		resyncPeriod,
